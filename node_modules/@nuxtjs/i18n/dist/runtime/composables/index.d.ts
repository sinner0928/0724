...
import type { RouteLocationAsPathGeneric, RouteLocationAsRelativeTypedI18n, RouteLocationResolvedI18n, RouteMap, RouteMapI18n } from 'vue-router';
 ...
 */
type RouteLocationI18nInput<Name extends keyof RouteMapI18n = keyof RouteMapI18n> = Name | RouteLocationAsRelativeTypedI18n<RouteMapI18n, Name> | RouteLocationAsPathGeneric;
/**
 ...
 */
export type LocalePathFunction = <Name extends keyof RouteMapI18n = keyof RouteMapI18n>(route: RouteLocationI18nInput<Name>, locale?: Locale) => string;
/**
 ...
 */
export type LocaleRouteFunction = <Name extends keyof RouteMapI18n = keyof RouteMapI18n>(route: RouteLocationI18nInput<Name>, locale?: Locale) => RouteLocationResolvedI18n<Name> | undefined;
/**
