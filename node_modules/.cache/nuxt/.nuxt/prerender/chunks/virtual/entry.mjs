import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineProdDiagnostics } from 'file://D:/aaxinwangzhan/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://D:/aaxinwangzhan/node_modules/nostics/dist/formatters/ansi.mjs';
import * as Vue from 'file://D:/aaxinwangzhan/node_modules/vue/index.mjs';
import { getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, hasInjectionContext, inject, defineComponent, mergeProps, toRef, onScopeDispose, computed, shallowRef, h, isReadonly, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, Text, Fragment, isRef, isShallow, isReactive, toRaw, isVNode, createCommentVNode, withCtx, Suspense, nextTick, resolveComponent, customRef, toValue } from 'file://D:/aaxinwangzhan/node_modules/vue/index.mjs';
import { createHooks } from 'file://D:/aaxinwangzhan/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://D:/aaxinwangzhan/node_modules/unctx/dist/index.mjs';
import { createError, getRequestURL, appendHeader, sanitizeStatusCode, getRequestHeader, getCookie, setCookie, deleteCookie } from 'file://D:/aaxinwangzhan/node_modules/h3/dist/index.mjs';
import { hasProtocol, parsePath, parseQuery, joinURL, isScriptProtocol, withQuery, parseURL, encodePath, decodePath, withTrailingSlash, withoutTrailingSlash, isEqual as isEqual$1 } from 'file://D:/aaxinwangzhan/node_modules/ufo/dist/index.mjs';
import { $fetch as $fetch$1 } from 'file://D:/aaxinwangzhan/node_modules/ofetch/dist/node.mjs';
import { n as baseURL } from '../_/nitro.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, useRoute, RouterView } from 'file://D:/aaxinwangzhan/node_modules/vue-router/vue-router.node.mjs';
import { isPlainObject } from 'file://D:/aaxinwangzhan/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import { createDefu, defu } from 'file://D:/aaxinwangzhan/node_modules/defu/dist/defu.mjs';
import { klona } from 'file://D:/aaxinwangzhan/node_modules/klona/dist/index.mjs';
import { fnv1a64Base36 } from 'file://D:/aaxinwangzhan/node_modules/fnv1a-64/dist/index.mjs';
import { identify } from 'file://D:/aaxinwangzhan/node_modules/object-identity/index.js';
import { debounce } from 'file://D:/aaxinwangzhan/node_modules/perfect-debounce/dist/index.mjs';
import { parse } from 'file://D:/aaxinwangzhan/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import { isEqual } from 'file://D:/aaxinwangzhan/node_modules/ohash/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate } from 'file://D:/aaxinwangzhan/node_modules/vue/server-renderer/index.mjs';
import { FlatMetaPlugin } from 'file://D:/aaxinwangzhan/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file://D:/aaxinwangzhan/node_modules/unhead/dist/utils.mjs';
import { i as injectHead$1, V as VueResolver, h as headSymbol } from '../_/renderer.mjs';
...
function buildAsyncData(nuxtApp, key, _handler, options, initialCachedData) {
	...
	const handler = !nuxtApp.ssrContext?.["~sharedPrerenderCache"] ? _handler : (nuxtApp, options) => {
...
var plugin = /* @__PURE__ */ defineNuxtPlugin(async () => {
	...
	routes ||= Array.from(processRoutes(([__temp, __restore] = executeAsync(() => virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Frouter_options_default.routes?.(virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default)), __temp = await __temp, __restore(), __temp) ?? virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default));
...
function processRoutes(routes, currentPath = "/", routesToPrerender = /* @__PURE__ */ new Set()) {
	for (const route of routes) {
		if (OPTIONAL_PARAM_RE.test(route.path) && !route.children?.length && shouldPrerender()) routesToPrerender.add(currentPath);
