...
import { H as HeaderOptions, P as PathOptions, Q as QueryOptions } from './shared/utils.c496264f.cjs';
 ...
 */
declare function getHeaderLanguages(context: Context, { name, parser, }?: HeaderOptions): string[];
/**
 ...
 */
declare function getHeaderLanguage(context: Context, { name, parser, }?: HeaderOptions): string;
/**
 ...
 */
declare function getHeaderLocales(context: Context, { name, parser, }?: HeaderOptions): Intl.Locale[];
/**
 ...
 */
declare function tryHeaderLocales(context: Context, { name, parser, }?: HeaderOptions): Intl.Locale[] | null;
/**
 ...
 */
declare function getHeaderLocale(context: Context, { lang, name, parser, }?: HeaderOptions & {
    lang?: string;
}): Intl.Locale;
/**
 ...
 */
declare function tryHeaderLocale(context: Context, { lang, name, parser, }?: HeaderOptions & {
    lang?: string;
}): Intl.Locale | null;
/**
 ...
 */
declare function getCookieLocale(context: Context, { lang, name }?: {
 ...
 */
declare function tryCookieLocale(context: Context, { lang, name }?: {
    lang?: string | undefined;
    name?: string | undefined;
}): Intl.Locale | null;
/**
 ...
 */
declare function setCookieLocale(context: Context, locale: string | Intl.Locale, options?: CookieOptions): void;
/**
 ...
 */
declare function getPathLocale(context: Context, { lang, parser }?: PathOptions): Intl.Locale;
/**
 ...
 */
declare function tryPathLocale(context: Context, { lang, parser }?: PathOptions): Intl.Locale | null;
/**
 ...
 */
declare function getQueryLocale(context: Context, { lang, name }?: QueryOptions): Intl.Locale;
/**
 ...
 */
declare function tryQueryLocale(context: Context, { lang, name }?: QueryOptions): Intl.Locale | null;
